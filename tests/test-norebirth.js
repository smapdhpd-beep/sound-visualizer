...
draw(simulate(4, 0.9, 0.2, 0.4, 0.3, 1.0, 800), 'norebirth-bass');
draw(simulate(4, 0.2, 0.8, 0.6, 0.5, 1.0, 800), 'norebirth-high');
draw(simulate(5, 0.6, 0.7, 0.8, 0.6, 1.0, 800), 'norebirth-mix');
