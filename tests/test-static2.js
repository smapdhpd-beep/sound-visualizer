...
// 测试不同 radius
draw(simulateStatic(4, 0.88, 0.08, 0.05, 1.0, 800), 's-r088');
draw(simulateStatic(4, 0.70, 0.08, 0.05, 1.0, 800), 's-r070');
draw(simulateStatic(4, 0.55, 0.08, 0.05, 1.0, 800), 's-r055');
draw(simulateStatic(4, 0.40, 0.08, 0.05, 1.0, 800), 's-r040');

// 测试不同 baseFreq
draw(simulateStatic(4, 0.55, 0.04, 0.05, 1.0, 800), 's-f004');
draw(simulateStatic(4, 0.55, 0.10, 0.05, 1.0, 800), 's-f010');
draw(simulateStatic(4, 0.55, 0.18, 0.05, 1.0, 800), 's-f018');
